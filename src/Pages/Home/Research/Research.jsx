            ...
            <div className="card bg-[#FDEEDC] hover:bg-gradient-to-br from-amber-100 to-orange-200 py-4  flex justify-center items-center" >
              <div className="flex justify-start items-center ">
               ...
               <div className="w-1/2">
                  <img
                    className="w-full"
                    src="https://i.ibb.co/4s5gfDm/ai-med.jpg"
                    alt=""
                  />
                </div>
                <div className="basis-1/2">
                  <h2 className="text-xl">The Role of Artificial Intelligence in Early Cancer Diagnosis</h2>
                  <p>Benjamin Hunter, Sumeet Hindocha,</p>
                  <Link to='https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8946688/'><button className="btn btn-neutral"> Read</button></Link>
                </div>
               </div>
              </div>
            </div>
          ...
          <div className="card" data-aos ="fade-right">
            ...
            <div className="card " data-aos="zoom-in" >
              <img
                ...
                src="https://www.discoverphds.com/wp-content/uploads/elementor/thumbs/What-is-Research-Purpose-of-Research-phul4s3cbwe0xam190dnc4kz3z616ajmfkygodcdqg.png"
                alt=""
              />
            </div>
